...
def main(epochs,MODEL_NAME = "LPRnet_edgetpu"):
    ...
    model.fit_generator(generator=generate,validation_data=real_dataset,validation_steps=3,epochs=int(epochs),steps_per_epoch=10,callbacks=[WandbCallback(),check])
